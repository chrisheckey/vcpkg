...
if ("maya" IN_LIST FEATURES)
    set(OPENVDB_BUILD_MAYA_PLUGIN ON)
else()
    set(OPENVDB_BUILD_MAYA_PLUGIN OFF)
endif()

file(TO_NATIVE_PATH "${VCPKG_ROOT_DIR}/installed/${TARGET_TRIPLET}" INSTALL_LOCATION)
file(TO_NATIVE_PATH "${VCPKG_ROOT_DIR}/dcc_plugins/${TARGET_TRIPLET}/maya" MAYA_PLUGINS)
...
vcpkg_configure_cmake(
    ...
    OPTIONS -DOPENVDB_BUILD_UNITTESTS=OFF
            ...
            -DOPENVDB_BUILD_MAYA_PLUGIN=${OPENVDB_BUILD_MAYA_PLUGIN}
    OPTIONS_RELEASE
